...
# ══════════════════════════════════════════════════════
# 1. IDENTIDAD VISUAL Y CSS DE ALTA PRESIÓN
# ══════════════════════════════════════════════════════
...
<style>
    ...
    /* TRUCO DE CENTRADO ABSOLUTO PARA EL BOTÓN */
    ...
    /* Estilo de la caja de selección */
...
if st.session_state.screen == 'splash':
    ...
    # Grid de 3 columnas para centrar el botón de Streamlit
...
<p style="font-family: 'Inter'; font-size: 12px; color: #8BA8C0; line-height: 1.4; margin-top: 5px;"><b>¿Por qué importa?</b> Garantiza que el fluido empuje el crudo sin "dedear" el agua.</p>
</div>
<div style="background: rgba(26, 42, 58, 0.4); border-left: 3px solid #22D3EE; border-radius: 8px; padding: 12px; margin-bottom: 10px;">
...
<p style="font-family: 'Inter'; font-size: 12px; color: #8BA8C0; line-height: 1.4; margin-top: 5px;"><b>¿Por qué importa?</b> Indica estabilidad bajo presión en el fondo del pozo.</p>
</div>
<div style="background: rgba(26, 42, 58, 0.4); border-left: 3px solid #22D3EE; border-radius: 8px; padding: 12px; margin-bottom: 10px;">
<p style="font-family: 'DM Mono'; font-size: 10px; color: #22D3EE; margin: 0; text-transform: uppercase;">PAYBACK: {pb_val} MESES</p>
<p style="font-family: 'Inter'; font-size: 12px; color: #8BA8C0; line-height: 1.4; margin-top: 5px;"><b>¿Por qué importa?</b> Retorno casi inmediato de la inversión tecnológica.</p>
</div>
